...
public class HanHistoryMancontrol : MonoBehaviour
{
    ...
    void SetIdleState()
    {
        ...
        {
            ResetAllAnimBools();
            m_Anim.SetBool("standing_idle", true);
    ...
    private void ResetAllAnimBools()
    {
        ...
        m_Anim.SetBool("standing_idle", false);
        m_Anim.SetBool("standup", false);
        m_Anim.SetBool("pointing", false);
    }
